...
copy('https://codeload.github.com/kiss291323003/easyswoole/zip/master','./easyswoole-master.zip');
echo "unzip...\n";
$zip->open("easyswoole-master.zip");
echo "extract....\n";
$zip->extractTo("./");
FileUtil::moveDir("./easyswoole-master/src",'./');
FileUtil::deleteDir("./easyswoole-master");
FileUtil::deleteFile('./easyswoole-master.zip');
